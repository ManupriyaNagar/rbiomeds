    ...
    const businesses = [
        {
            ...
            logo: "/logoa.png",
            description: "Most trusted and respected healthcare organizations",
            bgColor: "#ea9237",
            ...
            <div className="container mx-auto px-6 bg-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-7xl mx-auto">
                    {businesses.map((biz, index) => (
                        ...
                        >
                            <div
                                className="relative h-full rounded-[2.5rem] p-4 border-1 border-black/10 transition-all duration-500"
