            ...
            <div className="container mx-auto px-6">
                ...
                <div className="text-center mb-12 mt-10 2xl:mt-20">
                    ...
                    <p className="max-w-7xl mx-auto text-gray-500 text-lg leading-relaxed">
                        At R-Biomeds, we believe that understanding your metrics is the first step toward lasting wellness.
                ...
                <div className="md:hidden mb-8 px-4 relative">
                    <select
                        value={activeTab}
                        onChange={(e) => { setActiveTab(e.target.value); reset(); }}
                        className="w-full p-3 rounded-lg border border-gray-300 bg-gradient-to-r from-red-900 to-[#ef662a] text-white focus:outline-none focus:ring-2 focus:ring-[#ef662a]  appearance-none"
                    >
                        {tabs.map((tab) => (
