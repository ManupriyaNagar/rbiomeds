            ...
            <div className="container mx-auto">
                <div className="bg-[#ef662e] rounded-[2.5rem] overflow-hidden relative min-h-[400px]">
                    <div className="grid grid-cols-1 lg:grid-cols-12 items-center">
                        ...
                        <div className="lg:col-span-7 p-8 md:p-10 2xl:p-12 lg:p-10 text-white">
                            <h1 className='text-4xl md:text-4xl font-medium text-white mb-4'>Chairman's Message</h1>
                            <div className="space-y-4">
                                <p className="text-white/90 text-sm md:text-base 2xl:text-lg leading-relaxed font-medium">
                            ...
                            <div className="mt-8">
                                ...
                                <p className="text-white font-extrabold text-2xl md:text-3xl mt-1">Rajeev Rawal</p>
                            </div>
                        </div>
