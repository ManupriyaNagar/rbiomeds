            ...
            <div className="container mx-auto px-4 md:px-0 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-start gap-12 lg:gap-16">
                    <div className="w-full flex flex-col md:flex-row gap-8 lg:gap-12">
                        ...
                        <div className='md:w-[450px] shrink-0'>
                                        ...
                                        {[
                                            {
                                                ...
                                                textColor: "text-[#5b2c6f]"
                                            },
                                            {
                                                country: "MYANMAR",
                                                flag: "https://flagcdn.com/w160/mm.png",
                                                address: "No.002, Shwe Than Lwin Condo, Bahan Township, Yangon, Myanmar, 11201",
                                                phone: "+95943040374, +95979845393",
                                            ...
                                            },
                                            {
                                                ...
                                                address: "105, Sagar Complex, Pitampura, New Delhi 110034",
                                                phone: "+91 987133044",
                                            ...
                                            <div key={idx} className={`relative bg-white border-[3px] ${item.borderColor} rounded-full px-8 py-5 hover:scale-[1.02] transition-all group max-w-[450px]`}>
                                                {/* Ribbon Flag Badge */}
                                                ...
                                                <div className="flex flex-col pr-16">
                                                    <h5 className={`${item.textColor} font-black text-2xl tracking-tighter mb-1 uppercase `}>{item.country}</h5>
                                                    <div className="space-y-0.5">
                                                        <p className="text-gray-800 text-sm font-bold leading-tight">
                                                            <span className="font-semibold text-gray-600">{item.address}</span>
                                                        </p>
                                                        {item.phone && (
                                                            <p className="text-[#ef662e] text-xs font-black tracking-tight uppercase">
                                                                PH: {item.phone}
                                                            </p>
                                                        )}
                                                    </div>
                 ...
                 hover:bg-[#0A66C2] hover:text-white hover:scale-110"
                        ...
                        <div className="flex-1 flex flex-col gap-4">
                            {/* Map Container */}
                            <div className="w-full h-[350px] rounded-[2rem] overflow-hidden  border-4 border-white relative mt-8">
                                <iframe
